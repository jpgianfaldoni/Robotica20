...
while(True):
    ...
    if circles is not None:
        ...
        if len(centro)>= 2:
            ...
            cv2.putText(bordas_color,str(dist),(150,50), font, 1,(255,255,255),2,cv2.LINE_AA)
            cv2.putText(bordas_color,("distancia"),(0,50), font, 1,(255,255,255),2,cv2.LINE_AA)
            cv2.putText(bordas_color,("angulo"),(0,100), font, 1,(255,255,255),2,cv2.LINE_AA)
            cv2.putText(bordas_color,str(angle_degree),(120,100), font, 1,(255,255,255),2,cv2.LINE_AA)
